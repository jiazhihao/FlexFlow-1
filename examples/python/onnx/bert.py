...
def top_level_task():
  ...
  onnx_model = ONNXModel(f"{MODEL_DIRECTORY}/nasneta_{ffconfig.get_batch_size()}_unoptimized.onnx")
  # for node in onnx_model.model.graph.node:
  #     print(node.name)
  # print(onnx_model.model.graph.output[0].name)
  t = onnx_model.apply(ffmodel, {"data": input})
  print(t.dims)
  # t = ffmodel.transpose(t, [3, 2, 0, 1])
  # print(t.dims)
  t = ffmodel.relu(t)
